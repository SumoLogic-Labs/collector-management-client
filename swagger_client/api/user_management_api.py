...
class UserManagementApi(object):
    ...
    def create_user(self, body, **kwargs):  # noqa: E501
        ...
        Create a new user in the organization.  # noqa: E501
        ...
        :param CreateUserDefinition body: Information about the new user. (required)
        :return: UserModel
    ...
    def delete_user(self, id, **kwargs):  # noqa: E501
        ...
        Delete a user with the given identifier from the organization and transfer their content to the user with the identifier specified in \"transferTo\". If \"transferTo\" is not specified the contents are deleted.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: Identifier of the user to delete. (required)
        :param str transfer_to: Identifier of the user to receive the transfer of content from the deleted user.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_user_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'transfer_to']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'transfer_to' in params:
            query_params.append(('transferTo', params['transfer_to']))  # noqa: E501
    ...
    def get_user(self, id, **kwargs):  # noqa: E501
        ...
        Get a user with the given identifier from the organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: Identifier of user to return. (required)
        :return: UserModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_users(self, **kwargs):  # noqa: E501
        ...
        Get a list of all users in the organization. The response is paginated with a default limit of 100 users per page.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param int limit: Limit the number of users returned in the response. The number of users returned may be less than the `limit`.
        ...
        :param str sort_by: Sort the list of users by the `firstName`, `lastName`, or `email` field.
        :param str email: Find user with the given email address.
    ...
    def list_users_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['limit', 'token', 'sort_by', 'email']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ListUserModelsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def request_change_email(self, body, id, **kwargs):  # noqa: E501
        """Change email address.  # noqa: E501

        An email with an activation link is sent to the user’s new email address. The user must click the link in the email within seven days to complete the email address change, or the link will expire.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.request_change_email(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ChangeEmailRequest body: New email address of the user. (required)
        :param str id: Identifier of the user to change email address. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.request_change_email_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.request_change_email_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def request_change_email_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Change email address.  # noqa: E501

        An email with an activation link is sent to the user’s new email address. The user must click the link in the email within seven days to complete the email address change, or the link will expire.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.request_change_email_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method request_change_email" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `request_change_email`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `request_change_email`")  # noqa: E501
    ...
    def reset_password(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: Identifier of the user to reset password. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def unlock_user(self, id, **kwargs):  # noqa: E501
        ...
        Unlock another user's account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: The id of the user that needs to be unlocked. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_user(self, body, id, **kwargs):  # noqa: E501
        ...
        Update an existing user in the organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param UpdateUserDefinition body: Information to update about the user. (required)
        :param str id: Identifier of the user to update. (required)
        :return: UserModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
