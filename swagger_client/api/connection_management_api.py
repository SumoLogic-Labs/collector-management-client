...
class ConnectionManagementApi(object):
    ...
    def create_connection(self, body, **kwargs):  # noqa: E501
        ...
        Create a new connection in the organization.  # noqa: E501
        ...
        :param ConnectionDefinition body: Information about the new connection. (required)
        :return: Connection
    ...
    def delete_connection(self, id, type, **kwargs):  # noqa: E501
        """Delete a connection.  # noqa: E501

        Delete a connection with the given identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_connection(id, type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Identifier of the connection to delete. (required)
        :param str type: Type of connection to delete. Valid values are `WebhookConnection`, `ServiceNowConnection`. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_connection_with_http_info(id, type, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_connection_with_http_info(id, type, **kwargs)  # noqa: E501
            return data

    def delete_connection_with_http_info(self, id, type, **kwargs):  # noqa: E501
        """Delete a connection.  # noqa: E501

        Delete a connection with the given identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_connection_with_http_info(id, type, async_req=True)
        >>> result = thread.get()
        ...
        if ('type' not in params or
                params['type'] is None):
            raise ValueError("Missing the required parameter `type` when calling `delete_connection`")  # noqa: E501
    ...
    def get_connection(self, id, type, **kwargs):  # noqa: E501
        """Get a connection.  # noqa: E501

        Get a connection with the given identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_connection(id, type, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: Identifier of connection to return. (required)
        :param str type: Type of connection to return. Valid values are `WebhookConnection`, `ServiceNowConnection`. (required)
        :return: Connection
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_connection_with_http_info(id, type, **kwargs)  # noqa: E501
        else:
            (data) = self.get_connection_with_http_info(id, type, **kwargs)  # noqa: E501
            return data

    def get_connection_with_http_info(self, id, type, **kwargs):  # noqa: E501
        """Get a connection.  # noqa: E501

        Get a connection with the given identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_connection_with_http_info(id, type, async_req=True)
        >>> result = thread.get()
        ...
        if ('type' not in params or
                params['type'] is None):
            raise ValueError("Missing the required parameter `type` when calling `get_connection`")  # noqa: E501
    ...
    def list_connections(self, **kwargs):  # noqa: E501
        ...
        Get a list of all connections in the organization. The response is paginated with a default limit of 100 connections per page.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param int limit: Limit the number of connections returned in the response. The number of connections returned may be less than the `limit`.
    ...
    def list_connections_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ListConnectionsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def test_connection(self, body, **kwargs):  # noqa: E501
        """Test a new connection url.  # noqa: E501

        Test a new connection url is valid and can connect.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def test_connection_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TestConnectionResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_connection(self, body, id, **kwargs):  # noqa: E501
        """Update a connection.  # noqa: E501

        Update an existing connection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_connection(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ConnectionDefinition body: Information to update about the connection. (required)
        :param str id: Identifier of the connection to update. (required)
        :return: Connection
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_connection_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_connection_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_connection_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update a connection.  # noqa: E501

        Update an existing connection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_connection_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
