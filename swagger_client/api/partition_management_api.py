...
class PartitionManagementApi(object):
    ...
    def create_partition(self, body, **kwargs):  # noqa: E501
        ...
        :param CreatePartitionDefinition body: Information about the new partition. (required)
        :return: Partition
    ...
    def decommission_partition(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: Identifier of the partition to decommission. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.decommission_partition_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.decommission_partition_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def decommission_partition_with_http_info(self, id, **kwargs):  # noqa: E501
        """Decommission a partition.  # noqa: E501

        Decommission a partition with the given identifier from the organization.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.decommission_partition_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method decommission_partition" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `decommission_partition`")  # noqa: E501
    ...
    def get_partition(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: Identifier of partition to return. (required)
        :return: Partition
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_partitions(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int limit: Limit the number of partitions returned in the response. The number of partitions returned may be less than the `limit`.
    ...
    def list_partitions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ListPartitionsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_partition(self, body, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param UpdatePartitionDefinition body: Information to update about the partition. (required)
        :param str id: Identifier of the partition to update. (required)
        :return: Partition
                 If the method is called asynchronously,
                 returns the request thread.
        """
