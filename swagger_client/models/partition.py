...
import six
from swagger_client.models.create_partition_definition import CreatePartitionDefinition  # noqa: F401,E501


class Partition(CreatePartitionDefinition):
    ...
    if hasattr(CreatePartitionDefinition, "swagger_types"):
        swagger_types.update(CreatePartitionDefinition.swagger_types)
    ...
    if hasattr(CreatePartitionDefinition, "attribute_map"):
        attribute_map.update(CreatePartitionDefinition.attribute_map)

    def __init__(self, id=None, is_active=None, created_at=None, created_by=None, modified_at=None, *args, **kwargs):  # noqa: E501
        ...
        CreatePartitionDefinition.__init__(self, *args, **kwargs)

    @property
    def id(self):
        """Gets the id of this Partition.  # noqa: E501

        Unique identifier for the partition.  # noqa: E501
    ...
    @property
    def is_active(self):
        """Gets the is_active of this Partition.  # noqa: E501

        This has the value `true` if the partition is active and `false` if it has been decommissioned.  # noqa: E501

        :return: The is_active of this Partition.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_active(self, is_active):
        """Sets the is_active of this Partition.

        This has the value `true` if the partition is active and `false` if it has been decommissioned.  # noqa: E501

        :param is_active: The is_active of this Partition.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def created_at(self):
        """Gets the created_at of this Partition.  # noqa: E501

        Creation timestamp in UTC in [RFC3339](https://tools.ietf.org/html/rfc3339) format.  # noqa: E501

        :return: The created_at of this Partition.  # noqa: E501
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this Partition.

        Creation timestamp in UTC in [RFC3339](https://tools.ietf.org/html/rfc3339) format.  # noqa: E501

        :param created_at: The created_at of this Partition.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def created_by(self):
        """Gets the created_by of this Partition.  # noqa: E501

        Identifier of the user who created the resource.  # noqa: E501

        :return: The created_by of this Partition.  # noqa: E501
        :rtype: str
        """
    ...
    def created_by(self, created_by):
        """Sets the created_by of this Partition.

        Identifier of the user who created the resource.  # noqa: E501

        :param created_by: The created_by of this Partition.  # noqa: E501
        :type: str
        """
    ...
    def modified_at(self):
        """Gets the modified_at of this Partition.  # noqa: E501

        Last modification timestamp in UTC.  # noqa: E501

        :return: The modified_at of this Partition.  # noqa: E501
        :rtype: datetime
        """
    ...
    def modified_at(self, modified_at):
        """Sets the modified_at of this Partition.

        Last modification timestamp in UTC.  # noqa: E501

        :param modified_at: The modified_at of this Partition.  # noqa: E501
        :type: datetime
        """
