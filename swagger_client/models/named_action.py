...
class NamedAction(Action):
    ...
    def __init__(self, action_path=None, action_parameters=None, *args, **kwargs):  # noqa: E501
        """NamedAction - a model defined in Swagger"""  # noqa: E501
    ...
    def action_path(self):
        """Gets the action_path of this NamedAction.  # noqa: E501

        The path to the named action to be invoked.  # noqa: E501

        :return: The action_path of this NamedAction.  # noqa: E501
        :rtype: str
        """
    ...
    def action_path(self, action_path):
        """Sets the action_path of this NamedAction.

        The path to the named action to be invoked.  # noqa: E501

        :param action_path: The action_path of this NamedAction.  # noqa: E501
        :type: str
        """
        if action_path is None:
            raise ValueError("Invalid value for `action_path`, must not be `None`")  # noqa: E501

        self._action_path = action_path

    @property
    def action_parameters(self):
        """Gets the action_parameters of this NamedAction.  # noqa: E501

        The parameters to be passed to the action to be invoked.  # noqa: E501

        :return: The action_parameters of this NamedAction.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def action_parameters(self, action_parameters):
        """Sets the action_parameters of this NamedAction.

        The parameters to be passed to the action to be invoked.  # noqa: E501

        :param action_parameters: The action_parameters of this NamedAction.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NamedAction, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NamedAction):
            return False
