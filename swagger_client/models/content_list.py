...
class ContentList(object):
    ...
    @property
    def data(self):
        """Gets the data of this ContentList.  # noqa: E501

        A list of the content items.  # noqa: E501

        :return: The data of this ContentList.  # noqa: E501
        :rtype: list[Content]
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ContentList.

        A list of the content items.  # noqa: E501

        :param data: The data of this ContentList.  # noqa: E501
        :type: list[Content]
        """
        if data is None:
