...
import six
from swagger_client.models.role_model import RoleModel  # noqa: F401,E501


class ListRoleModelsResponse(object):
    ...
    def __init__(self, data=None, next=None):  # noqa: E501
        """ListRoleModelsResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._next = None
    ...
    @property
    def data(self):
        """Gets the data of this ListRoleModelsResponse.  # noqa: E501

        List of roles.  # noqa: E501

        :return: The data of this ListRoleModelsResponse.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ListRoleModelsResponse.

        List of roles.  # noqa: E501

        :param data: The data of this ListRoleModelsResponse.  # noqa: E501
        :type: list[RoleModel]
        """
        if data is None:
    ...
    @property
    def next(self):
        """Gets the next of this ListRoleModelsResponse.  # noqa: E501

        Next continuation token.  # noqa: E501

        :return: The next of this ListRoleModelsResponse.  # noqa: E501
        :rtype: str
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this ListRoleModelsResponse.

        Next continuation token.  # noqa: E501

        :param next: The next of this ListRoleModelsResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListRoleModelsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRoleModelsResponse):
            return False
