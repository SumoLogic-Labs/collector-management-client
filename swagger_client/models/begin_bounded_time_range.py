...
class BeginBoundedTimeRange(ResolvableTimeRange):
    ...
    """
    swagger_types = {
        '_from': 'TimeRangeBoundary',
        'to': 'TimeRangeBoundary'
    }
    if hasattr(ResolvableTimeRange, "swagger_types"):
        swagger_types.update(ResolvableTimeRange.swagger_types)

    attribute_map = {
        '_from': 'from',
        'to': 'to'
    }
    if hasattr(ResolvableTimeRange, "attribute_map"):
        attribute_map.update(ResolvableTimeRange.attribute_map)

    def __init__(self, _from=None, to=None, *args, **kwargs):  # noqa: E501
        """BeginBoundedTimeRange - a model defined in Swagger"""  # noqa: E501
        self.__from = None
        self._to = None
        ...
        if to is not None:
            self.to = to
        ResolvableTimeRange.__init__(self, *args, **kwargs)

    @property
    def _from(self):
        """Gets the _from of this BeginBoundedTimeRange.  # noqa: E501


        :return: The _from of this BeginBoundedTimeRange.  # noqa: E501
        :rtype: TimeRangeBoundary
        """
        return self.__from

    @_from.setter
    def _from(self, _from):
        """Sets the _from of this BeginBoundedTimeRange.


        :param _from: The _from of this BeginBoundedTimeRange.  # noqa: E501
    ...
    @property
    def to(self):
        """Gets the to of this BeginBoundedTimeRange.  # noqa: E501


        :return: The to of this BeginBoundedTimeRange.  # noqa: E501
        :rtype: TimeRangeBoundary
        """
        return self._to
    ...
    @to.setter
    def to(self, to):
        """Sets the to of this BeginBoundedTimeRange.


        :param to: The to of this BeginBoundedTimeRange.  # noqa: E501
        :type: TimeRangeBoundary
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BeginBoundedTimeRange, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BeginBoundedTimeRange):
            return False
