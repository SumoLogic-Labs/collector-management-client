...
class BulkBeginAsyncJobResponse(object):
    ...
    def __init__(self, job_ids=None, errors=None):  # noqa: E501
        """BulkBeginAsyncJobResponse - a model defined in Swagger"""  # noqa: E501
        self._job_ids = None
        self._errors = None
    ...
    @property
    def job_ids(self):
        """Gets the job_ids of this BulkBeginAsyncJobResponse.  # noqa: E501

        Map of content identifiers to job identifiers.  # noqa: E501

        :return: The job_ids of this BulkBeginAsyncJobResponse.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def job_ids(self, job_ids):
        """Sets the job_ids of this BulkBeginAsyncJobResponse.

        Map of content identifiers to job identifiers.  # noqa: E501

        :param job_ids: The job_ids of this BulkBeginAsyncJobResponse.  # noqa: E501
        :type: dict(str, str)
        """
        if job_ids is None:
    ...
    @property
    def errors(self):
        """Gets the errors of this BulkBeginAsyncJobResponse.  # noqa: E501

        Map of content identifiers to error messages for all failed job requests  # noqa: E501

        :return: The errors of this BulkBeginAsyncJobResponse.  # noqa: E501
    ...
    def errors(self, errors):
        """Sets the errors of this BulkBeginAsyncJobResponse.

        Map of content identifiers to error messages for all failed job requests  # noqa: E501

        :param errors: The errors of this BulkBeginAsyncJobResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkBeginAsyncJobResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkBeginAsyncJobResponse):
            return False
