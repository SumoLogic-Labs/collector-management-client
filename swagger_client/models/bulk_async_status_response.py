...
import six
from swagger_client.models.async_job_status import AsyncJobStatus  # noqa: F401,E501
from swagger_client.models.bulk_error_response import BulkErrorResponse  # noqa: F401,E501


class BulkAsyncStatusResponse(object):
    ...
    """
    swagger_types = {
        'job_statuses': 'dict(str, AsyncJobStatus)',
        'errors': 'dict(str, BulkErrorResponse)'
    }
    ...
    def __init__(self, job_statuses=None, errors=None):  # noqa: E501
        """BulkAsyncStatusResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def job_statuses(self):
        """Gets the job_statuses of this BulkAsyncStatusResponse.  # noqa: E501

        Map of job identifiers to job statuses.  # noqa: E501

        :return: The job_statuses of this BulkAsyncStatusResponse.  # noqa: E501
        :rtype: dict(str, AsyncJobStatus)
        """
        return self._job_statuses

    @job_statuses.setter
    def job_statuses(self, job_statuses):
        """Sets the job_statuses of this BulkAsyncStatusResponse.

        Map of job identifiers to job statuses.  # noqa: E501

        :param job_statuses: The job_statuses of this BulkAsyncStatusResponse.  # noqa: E501
        :type: dict(str, AsyncJobStatus)
        """
        if job_statuses is None:
            raise ValueError("Invalid value for `job_statuses`, must not be `None`")  # noqa: E501

        self._job_statuses = job_statuses

    @property
    def errors(self):
        """Gets the errors of this BulkAsyncStatusResponse.  # noqa: E501

        Map of content identifiers to error messages for all failed job requests  # noqa: E501

        :return: The errors of this BulkAsyncStatusResponse.  # noqa: E501
        :rtype: dict(str, BulkErrorResponse)
        """
        return self._errors

    @errors.setter
    def errors(self, errors):
        """Sets the errors of this BulkAsyncStatusResponse.

        Map of content identifiers to error messages for all failed job requests  # noqa: E501

        :param errors: The errors of this BulkAsyncStatusResponse.  # noqa: E501
        :type: dict(str, BulkErrorResponse)
        """
        if errors is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkAsyncStatusResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkAsyncStatusResponse):
            return False
