...
class RuleWarnings(object):
    ...
    def __init__(self, warnings=None):  # noqa: E501
        """RuleWarnings - a model defined in Swagger"""  # noqa: E501
        self._warnings = None
    ...
    @property
    def warnings(self):
        """Gets the warnings of this RuleWarnings.  # noqa: E501

        A map of keys to any warnings.  # noqa: E501

        :return: The warnings of this RuleWarnings.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def warnings(self, warnings):
        """Sets the warnings of this RuleWarnings.

        A map of keys to any warnings.  # noqa: E501

        :param warnings: The warnings of this RuleWarnings.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RuleWarnings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RuleWarnings):
            return False
