...
class RelativeTimeRangeBoundary(TimeRangeBoundary):
    ...
    def __init__(self, relative_time=None, *args, **kwargs):  # noqa: E501
        """RelativeTimeRangeBoundary - a model defined in Swagger"""  # noqa: E501
    ...
    def relative_time(self):
        """Gets the relative_time of this RelativeTimeRangeBoundary.  # noqa: E501

        Relative time as a string consisting of following elements: - `-` (optional): minus sign indicates time in the past, - `<number>`: number of time units, - `<time_unit>`: time unit; possible values are: `w` (week), `d` (day), `h` (hour), `m` (minute), `s` (second). Multiple pairs of `<number><time_unit>` may be provided, and they may be in any order. For example, `-2w5d3h` points to the moment in time 2 weeks, 5 days and 3 hours ago.  # noqa: E501

        :return: The relative_time of this RelativeTimeRangeBoundary.  # noqa: E501
        :rtype: str
        """
        return self._relative_time

    @relative_time.setter
    def relative_time(self, relative_time):
        """Sets the relative_time of this RelativeTimeRangeBoundary.

        Relative time as a string consisting of following elements: - `-` (optional): minus sign indicates time in the past, - `<number>`: number of time units, - `<time_unit>`: time unit; possible values are: `w` (week), `d` (day), `h` (hour), `m` (minute), `s` (second). Multiple pairs of `<number><time_unit>` may be provided, and they may be in any order. For example, `-2w5d3h` points to the moment in time 2 weeks, 5 days and 3 hours ago.  # noqa: E501

        :param relative_time: The relative_time of this RelativeTimeRangeBoundary.  # noqa: E501
        :type: str
        """
        if relative_time is None:
            raise ValueError("Invalid value for `relative_time`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RelativeTimeRangeBoundary, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RelativeTimeRangeBoundary):
            return False
