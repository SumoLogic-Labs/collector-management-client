...
class TimeRangeBoundary(object):
    ...
    discriminator_value_class_map = {
          ...
          'Iso8601TimeRangeBoundary': 'Iso8601TimeRangeBoundary',
'LiteralTimeRangeBoundary': 'LiteralTimeRangeBoundary',
'EpochTimeRangeBoundary': 'EpochTimeRangeBoundary',
'RelativeTimeRangeBoundary': 'RelativeTimeRangeBoundary'    }

    def __init__(self, type=None):  # noqa: E501
        """TimeRangeBoundary - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this TimeRangeBoundary.  # noqa: E501

        Type of the time range boundary. Value must be from list: - `RelativeTimeRangeBoundary`, - `EpochTimeRangeBoundary`, - `Iso8601TimeRangeBoundary`, - `LiteralTimeRangeBoundary`.  # noqa: E501

        :return: The type of this TimeRangeBoundary.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TimeRangeBoundary.

        Type of the time range boundary. Value must be from list: - `RelativeTimeRangeBoundary`, - `EpochTimeRangeBoundary`, - `Iso8601TimeRangeBoundary`, - `LiteralTimeRangeBoundary`.  # noqa: E501

        :param type: The type of this TimeRangeBoundary.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TimeRangeBoundary, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TimeRangeBoundary):
            return False
