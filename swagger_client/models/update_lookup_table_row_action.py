...
class UpdateLookupTableRowAction(Action):
    ...
    attribute_map = {
        ...
        'lookup_table_path': 'lookupTablePath'
    }
    if hasattr(Action, "attribute_map"):
        attribute_map.update(Action.attribute_map)

    def __init__(self, lookup_table_id=None, column_values=None, lookup_table_path=None, *args, **kwargs):  # noqa: E501
        """UpdateLookupTableRowAction - a model defined in Swagger"""  # noqa: E501
        self._lookup_table_id = None
    ...
    @property
    def lookup_table_id(self):
        """Gets the lookup_table_id of this UpdateLookupTableRowAction.  # noqa: E501

        The identifier of the lookup table being updated.  # noqa: E501

        :return: The lookup_table_id of this UpdateLookupTableRowAction.  # noqa: E501
        :rtype: str
        """
        return self._lookup_table_id

    @lookup_table_id.setter
    def lookup_table_id(self, lookup_table_id):
        """Sets the lookup_table_id of this UpdateLookupTableRowAction.

        The identifier of the lookup table being updated.  # noqa: E501

        :param lookup_table_id: The lookup_table_id of this UpdateLookupTableRowAction.  # noqa: E501
        :type: str
        """
        if lookup_table_id is None:
            raise ValueError("Invalid value for `lookup_table_id`, must not be `None`")  # noqa: E501

        self._lookup_table_id = lookup_table_id

    @property
    def column_values(self):
        """Gets the column_values of this UpdateLookupTableRowAction.  # noqa: E501

        The column values to update in the lookup table.  # noqa: E501

        :return: The column_values of this UpdateLookupTableRowAction.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def column_values(self, column_values):
        """Sets the column_values of this UpdateLookupTableRowAction.

        The column values to update in the lookup table.  # noqa: E501

        :param column_values: The column_values of this UpdateLookupTableRowAction.  # noqa: E501
        :type: dict(str, str)
        """
        if column_values is None:
            raise ValueError("Invalid value for `column_values`, must not be `None`")  # noqa: E501

        self._column_values = column_values

    @property
    def lookup_table_path(self):
        """Gets the lookup_table_path of this UpdateLookupTableRowAction.  # noqa: E501

        The path of the lookup table being updated.  # noqa: E501

        :return: The lookup_table_path of this UpdateLookupTableRowAction.  # noqa: E501
        :rtype: str
        """
        return self._lookup_table_path

    @lookup_table_path.setter
    def lookup_table_path(self, lookup_table_path):
        """Sets the lookup_table_path of this UpdateLookupTableRowAction.

        The path of the lookup table being updated.  # noqa: E501

        :param lookup_table_path: The lookup_table_path of this UpdateLookupTableRowAction.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateLookupTableRowAction, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateLookupTableRowAction):
            return False
