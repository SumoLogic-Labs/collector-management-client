...
class MetricsQueryData(object):
    ...
    def __init__(self, metric=None, aggregation_type=None, group_by=None, filters=None):  # noqa: E501
        """MetricsQueryData - a model defined in Swagger"""  # noqa: E501
        self._metric = None
    ...
    @property
    def metric(self):
        """Gets the metric of this MetricsQueryData.  # noqa: E501

        The metric of the query.  # noqa: E501

        :return: The metric of this MetricsQueryData.  # noqa: E501
        :rtype: str
        """
        return self._metric
    ...
    def metric(self, metric):
        """Sets the metric of this MetricsQueryData.

        The metric of the query.  # noqa: E501

        :param metric: The metric of this MetricsQueryData.  # noqa: E501
        :type: str
        """
        if metric is None:
    ...
    def aggregation_type(self):
        """Gets the aggregation_type of this MetricsQueryData.  # noqa: E501

        The type of aggregation. Can be `Count`, `Minimum`, `Maximum`, `Sum` or `Average`.  # noqa: E501

        :return: The aggregation_type of this MetricsQueryData.  # noqa: E501
        :rtype: str
        """
    ...
    def aggregation_type(self, aggregation_type):
        """Sets the aggregation_type of this MetricsQueryData.

        The type of aggregation. Can be `Count`, `Minimum`, `Maximum`, `Sum` or `Average`.  # noqa: E501

        :param aggregation_type: The aggregation_type of this MetricsQueryData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def group_by(self):
        """Gets the group_by of this MetricsQueryData.  # noqa: E501

        The field to group the results by.  # noqa: E501

        :return: The group_by of this MetricsQueryData.  # noqa: E501
        :rtype: str
        """
    ...
    def group_by(self, group_by):
        """Sets the group_by of this MetricsQueryData.

        The field to group the results by.  # noqa: E501

        :param group_by: The group_by of this MetricsQueryData.  # noqa: E501
        :type: str
        """
        if group_by is None:
    ...
    @property
    def filters(self):
        """Gets the filters of this MetricsQueryData.  # noqa: E501

        A list of filters for the metrics query.  # noqa: E501

        :return: The filters of this MetricsQueryData.  # noqa: E501
        :rtype: list[MetricsFilter]
        """
        return self._filters

    @filters.setter
    def filters(self, filters):
        """Sets the filters of this MetricsQueryData.

        A list of filters for the metrics query.  # noqa: E501

        :param filters: The filters of this MetricsQueryData.  # noqa: E501
        :type: list[MetricsFilter]
        """
        if filters is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetricsQueryData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetricsQueryData):
            return False
