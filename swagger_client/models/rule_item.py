...
class RuleItem(object):
    ...
    def __init__(self, status=None, filters=None, join_expression=None, aggregation=None, rule_actions=None):  # noqa: E501
        """RuleItem - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._filters = None
    ...
    @property
    def status(self):
        """Gets the status of this RuleItem.  # noqa: E501

        The status of the cloud SIEM rule, either active or inactive.  # noqa: E501

        :return: The status of this RuleItem.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this RuleItem.

        The status of the cloud SIEM rule, either active or inactive.  # noqa: E501

        :param status: The status of this RuleItem.  # noqa: E501
        :type: str
        """
        if status is None:
    ...
    @property
    def filters(self):
        """Gets the filters of this RuleItem.  # noqa: E501

        One or more filter expressions against which incoming log messages will be compared. Messages that match the filter are passed on to the next rule components.  # noqa: E501

        :return: The filters of this RuleItem.  # noqa: E501
        :rtype: list[Filter]
        """
    ...
    def filters(self, filters):
        """Sets the filters of this RuleItem.

        One or more filter expressions against which incoming log messages will be compared. Messages that match the filter are passed on to the next rule components.  # noqa: E501

        :param filters: The filters of this RuleItem.  # noqa: E501
        :type: list[Filter]
        """
        if filters is None:
    ...
    def join_expression(self):
        """Gets the join_expression of this RuleItem.  # noqa: E501

        An expression, made up of one or more match expressions and the withinTime operator, that correlates filtered events or rule variables.  # noqa: E501

        :return: The join_expression of this RuleItem.  # noqa: E501
        :rtype: str
        """
    ...
    def join_expression(self, join_expression):
        """Sets the join_expression of this RuleItem.

        An expression, made up of one or more match expressions and the withinTime operator, that correlates filtered events or rule variables.  # noqa: E501

        :param join_expression: The join_expression of this RuleItem.  # noqa: E501
        :type: str
        """
    ...
    def aggregation(self):
        """Gets the aggregation of this RuleItem.  # noqa: E501


        :return: The aggregation of this RuleItem.  # noqa: E501
        :rtype: Aggregation
        """
    ...
    def aggregation(self, aggregation):
        """Sets the aggregation of this RuleItem.


        :param aggregation: The aggregation of this RuleItem.  # noqa: E501
        :type: Aggregation
        """
    ...
    def rule_actions(self):
        """Gets the rule_actions of this RuleItem.  # noqa: E501


        :return: The rule_actions of this RuleItem.  # noqa: E501
        :rtype: RuleActions
        """
    ...
    def rule_actions(self, rule_actions):
        """Sets the rule_actions of this RuleItem.


        :param rule_actions: The rule_actions of this RuleItem.  # noqa: E501
        :type: RuleActions
        """
