...
class FolderSyncDefinition(ContentSyncDefinition):
    ...
    swagger_types = {
        'description': 'str',
        'children': 'list[ContentSyncDefinition]'
    }
    ...
    def __init__(self, description=None, children=None, *args, **kwargs):  # noqa: E501
        """FolderSyncDefinition - a model defined in Swagger"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this FolderSyncDefinition.  # noqa: E501

        An optional description for the folder.  # noqa: E501

        :return: The description of this FolderSyncDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this FolderSyncDefinition.

        An optional description for the folder.  # noqa: E501

        :param description: The description of this FolderSyncDefinition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def children(self):
        """Gets the children of this FolderSyncDefinition.  # noqa: E501

        The items in the folder, a list of Dashboard and/or Folder items.  # noqa: E501

        :return: The children of this FolderSyncDefinition.  # noqa: E501
        :rtype: list[ContentSyncDefinition]
        """
        return self._children

    @children.setter
    def children(self, children):
        """Sets the children of this FolderSyncDefinition.

        The items in the folder, a list of Dashboard and/or Folder items.  # noqa: E501

        :param children: The children of this FolderSyncDefinition.  # noqa: E501
        :type: list[ContentSyncDefinition]
        """
        if children is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FolderSyncDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FolderSyncDefinition):
            return False
