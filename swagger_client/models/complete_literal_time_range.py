...
class CompleteLiteralTimeRange(ResolvableTimeRange):
    ...
    def __init__(self, range_name=None, *args, **kwargs):  # noqa: E501
        """CompleteLiteralTimeRange - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def range_name(self):
        """Gets the range_name of this CompleteLiteralTimeRange.  # noqa: E501

        Name of the complete time range. Possible values are: - `yesterday`, - `previous_week`, - `previous_month`.  # noqa: E501

        :return: The range_name of this CompleteLiteralTimeRange.  # noqa: E501
        :rtype: str
        """
    ...
    def range_name(self, range_name):
        """Sets the range_name of this CompleteLiteralTimeRange.

        Name of the complete time range. Possible values are: - `yesterday`, - `previous_week`, - `previous_month`.  # noqa: E501

        :param range_name: The range_name of this CompleteLiteralTimeRange.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CompleteLiteralTimeRange, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompleteLiteralTimeRange):
            return False
