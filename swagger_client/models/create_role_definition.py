...
class CreateRoleDefinition(object):
    ...
    def __init__(self, name=None, description=None, filter_predicate=None, users=None, capabilities=None):  # noqa: E501
        """CreateRoleDefinition - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this CreateRoleDefinition.  # noqa: E501

        Name of the role.  # noqa: E501

        :return: The name of this CreateRoleDefinition.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateRoleDefinition.

        Name of the role.  # noqa: E501

        :param name: The name of this CreateRoleDefinition.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this CreateRoleDefinition.  # noqa: E501

        Description of the role.  # noqa: E501

        :return: The description of this CreateRoleDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CreateRoleDefinition.

        Description of the role.  # noqa: E501

        :param description: The description of this CreateRoleDefinition.  # noqa: E501
        :type: str
        """
    ...
    def filter_predicate(self):
        """Gets the filter_predicate of this CreateRoleDefinition.  # noqa: E501
        ...
        :return: The filter_predicate of this CreateRoleDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def filter_predicate(self, filter_predicate):
        """Sets the filter_predicate of this CreateRoleDefinition.

        A search filter to restrict access to specific logs. The filter is silently added to the beginning of each query a user runs. For example, using '!_sourceCategory=billing' as a filter predicate will prevent users assigned to the role from viewing logs from the source category named 'billing'.  # noqa: E501

        :param filter_predicate: The filter_predicate of this CreateRoleDefinition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def users(self):
        """Gets the users of this CreateRoleDefinition.  # noqa: E501

        List of user identifiers to assign the role to.  # noqa: E501

        :return: The users of this CreateRoleDefinition.  # noqa: E501
        :rtype: list[str]
        """
        return self._users
    ...
    def users(self, users):
        """Sets the users of this CreateRoleDefinition.

        List of user identifiers to assign the role to.  # noqa: E501

        :param users: The users of this CreateRoleDefinition.  # noqa: E501
        :type: list[str]
        """
    ...
    def capabilities(self):
        """Gets the capabilities of this CreateRoleDefinition.  # noqa: E501
        ...
        :return: The capabilities of this CreateRoleDefinition.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def capabilities(self, capabilities):
        """Sets the capabilities of this CreateRoleDefinition.

        List of [capabilities](https://help.sumologic.com/Manage/Users-and-Roles/Manage-Roles/Role-Capabilities) associated with this role. Valid values are   ### Connections   - manageConnections   ### Collectors   - manageCollectors   - viewCollectors   ### Dashboards   - shareDashboardWhitelist   - shareDashboardWorld   ### Data Management   - manageContent   - manageDataVolumeFeed   - manageFieldExtractionRules   - manageIndexes   - manageS3DataForwarding   ### Metrics   - manageMonitors   - metricsExtraction   ### Security   - ipWhitelisting   - manageAccessKeys   - manageAuditDataFeed   - managePasswordPolicy   - manageSaml   - manageSupportAccountAccess   - manageUsersAndRoles   - shareDashboardOutsideOrg  # noqa: E501

        :param capabilities: The capabilities of this CreateRoleDefinition.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateRoleDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRoleDefinition):
            return False
