...
class ServiceNowDefinition(ConnectionDefinition):
    ...
    def __init__(self, url=None, username=None, password=None, *args, **kwargs):  # noqa: E501
        """ServiceNowDefinition - a model defined in Swagger"""  # noqa: E501
        self._url = None
        self._username = None
        self._password = None
    ...
    @property
    def url(self):
        """Gets the url of this ServiceNowDefinition.  # noqa: E501

        URL for the ServiceNow connection.  # noqa: E501

        :return: The url of this ServiceNowDefinition.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this ServiceNowDefinition.

        URL for the ServiceNow connection.  # noqa: E501

        :param url: The url of this ServiceNowDefinition.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    @property
    def username(self):
        """Gets the username of this ServiceNowDefinition.  # noqa: E501

        User name for the ServiceNow connection.  # noqa: E501

        :return: The username of this ServiceNowDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def username(self, username):
        """Sets the username of this ServiceNowDefinition.

        User name for the ServiceNow connection.  # noqa: E501

        :param username: The username of this ServiceNowDefinition.  # noqa: E501
        :type: str
        """
        if username is None:
    ...
    @property
    def password(self):
        """Gets the password of this ServiceNowDefinition.  # noqa: E501

        User password for the ServiceNow connection.  # noqa: E501

        :return: The password of this ServiceNowDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this ServiceNowDefinition.

        User password for the ServiceNow connection.  # noqa: E501

        :param password: The password of this ServiceNowDefinition.  # noqa: E501
        :type: str
        """
        if password is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServiceNowDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceNowDefinition):
            return False
