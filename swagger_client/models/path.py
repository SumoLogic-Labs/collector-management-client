...
import six
from swagger_client.models.path_item import PathItem  # noqa: F401,E501
...
class Path(object):
    ...
    def __init__(self, path_items=None, path=None):  # noqa: E501
    ...
    @property
    def path_items(self):
        """Gets the path_items of this Path.  # noqa: E501

        Elements of the path.  # noqa: E501

        :return: The path_items of this Path.  # noqa: E501
        :rtype: list[PathItem]
        """
    ...
    def path_items(self, path_items):
        ...
        :param path_items: The path_items of this Path.  # noqa: E501
        :type: list[PathItem]
        """
        if path_items is None:
            raise ValueError("Invalid value for `path_items`, must not be `None`")  # noqa: E501

        self._path_items = path_items

    @property
    def path(self):
        """Gets the path of this Path.  # noqa: E501

        String representation of the path.  # noqa: E501
