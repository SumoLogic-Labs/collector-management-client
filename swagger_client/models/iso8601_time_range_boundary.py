...
import six
from swagger_client.models.time_range_boundary import TimeRangeBoundary  # noqa: F401,E501


class Iso8601TimeRangeBoundary(TimeRangeBoundary):
    ...
    if hasattr(TimeRangeBoundary, "swagger_types"):
        swagger_types.update(TimeRangeBoundary.swagger_types)

    attribute_map = {
        'iso8601_time': 'iso8601Time'
    }
    if hasattr(TimeRangeBoundary, "attribute_map"):
        attribute_map.update(TimeRangeBoundary.attribute_map)

    def __init__(self, iso8601_time=None, *args, **kwargs):  # noqa: E501
        """Iso8601TimeRangeBoundary - a model defined in Swagger"""  # noqa: E501
        self._iso8601_time = None
        self.discriminator = None
        self.iso8601_time = iso8601_time
        TimeRangeBoundary.__init__(self, *args, **kwargs)

    @property
    def iso8601_time(self):
        """Gets the iso8601_time of this Iso8601TimeRangeBoundary.  # noqa: E501

        Starting point in time as a string in ISO 8601 format.  # noqa: E501

        :return: The iso8601_time of this Iso8601TimeRangeBoundary.  # noqa: E501
        :rtype: datetime
        """
        return self._iso8601_time

    @iso8601_time.setter
    def iso8601_time(self, iso8601_time):
        """Sets the iso8601_time of this Iso8601TimeRangeBoundary.

        Starting point in time as a string in ISO 8601 format.  # noqa: E501

        :param iso8601_time: The iso8601_time of this Iso8601TimeRangeBoundary.  # noqa: E501
        :type: datetime
        """
        if iso8601_time is None:
            raise ValueError("Invalid value for `iso8601_time`, must not be `None`")  # noqa: E501

        self._iso8601_time = iso8601_time
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Iso8601TimeRangeBoundary, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Iso8601TimeRangeBoundary):
            return False
