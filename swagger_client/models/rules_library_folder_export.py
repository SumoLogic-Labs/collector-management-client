...
class RulesLibraryFolderExport(RulesLibraryExportBase):
    ...
    """
    swagger_types = {
        'children': 'list[RulesLibraryExportBase]'
    }
    ...
    def __init__(self, children=None, *args, **kwargs):  # noqa: E501
        """RulesLibraryFolderExport - a model defined in Swagger"""  # noqa: E501
        self._children = None
    ...
    @property
    def children(self):
        """Gets the children of this RulesLibraryFolderExport.  # noqa: E501

        The items in the folder, a list of rules and/or folder items.  # noqa: E501

        :return: The children of this RulesLibraryFolderExport.  # noqa: E501
        :rtype: list[RulesLibraryExportBase]
        """
        return self._children

    @children.setter
    def children(self, children):
        """Sets the children of this RulesLibraryFolderExport.

        The items in the folder, a list of rules and/or folder items.  # noqa: E501

        :param children: The children of this RulesLibraryFolderExport.  # noqa: E501
        :type: list[RulesLibraryExportBase]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RulesLibraryFolderExport, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RulesLibraryFolderExport):
            return False
