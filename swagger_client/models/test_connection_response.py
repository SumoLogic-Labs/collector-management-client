...
class TestConnectionResponse(object):
    ...
    def __init__(self, status_code=None, response_content=None):  # noqa: E501
        """TestConnectionResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def status_code(self):
        """Gets the status_code of this TestConnectionResponse.  # noqa: E501

        Status code of the response of the connection test.  # noqa: E501

        :return: The status_code of this TestConnectionResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def status_code(self, status_code):
        """Sets the status_code of this TestConnectionResponse.

        Status code of the response of the connection test.  # noqa: E501

        :param status_code: The status_code of this TestConnectionResponse.  # noqa: E501
        :type: int
        """
    ...
    def response_content(self):
        """Gets the response_content of this TestConnectionResponse.  # noqa: E501

        Content of the response of the connection test.  # noqa: E501

        :return: The response_content of this TestConnectionResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def response_content(self, response_content):
        """Sets the response_content of this TestConnectionResponse.

        Content of the response of the connection test.  # noqa: E501

        :param response_content: The response_content of this TestConnectionResponse.  # noqa: E501
        :type: str
        """
        if response_content is None:
            raise ValueError("Invalid value for `response_content`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TestConnectionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TestConnectionResponse):
            return False
