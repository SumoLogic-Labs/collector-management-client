...
class UpdateUserDefinition(object):
    ...
    def __init__(self, first_name=None, last_name=None, is_active=None, role_ids=None):  # noqa: E501
        """UpdateUserDefinition - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def first_name(self):
        """Gets the first_name of this UpdateUserDefinition.  # noqa: E501

        First name of the user.  # noqa: E501

        :return: The first_name of this UpdateUserDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """Sets the first_name of this UpdateUserDefinition.

        First name of the user.  # noqa: E501

        :param first_name: The first_name of this UpdateUserDefinition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def last_name(self):
        """Gets the last_name of this UpdateUserDefinition.  # noqa: E501

        Last name of the user.  # noqa: E501

        :return: The last_name of this UpdateUserDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def last_name(self, last_name):
        """Sets the last_name of this UpdateUserDefinition.

        Last name of the user.  # noqa: E501

        :param last_name: The last_name of this UpdateUserDefinition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def is_active(self):
        """Gets the is_active of this UpdateUserDefinition.  # noqa: E501

        This has the value `true` if the user is active and `false` if they have been deactivated.  # noqa: E501

        :return: The is_active of this UpdateUserDefinition.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_active(self, is_active):
        """Sets the is_active of this UpdateUserDefinition.

        This has the value `true` if the user is active and `false` if they have been deactivated.  # noqa: E501

        :param is_active: The is_active of this UpdateUserDefinition.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def role_ids(self):
        """Gets the role_ids of this UpdateUserDefinition.  # noqa: E501

        List of role identifiers associated with the user.  # noqa: E501

        :return: The role_ids of this UpdateUserDefinition.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def role_ids(self, role_ids):
        """Sets the role_ids of this UpdateUserDefinition.

        List of role identifiers associated with the user.  # noqa: E501

        :param role_ids: The role_ids of this UpdateUserDefinition.  # noqa: E501
        :type: list[str]
        """
        if role_ids is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateUserDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateUserDefinition):
            return False
