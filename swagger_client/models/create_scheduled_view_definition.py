...
class CreateScheduledViewDefinition(object):
    ...
    def __init__(self, query=None, index_name=None, start_time=None, retention_period=-1, data_forwarding_id=None):  # noqa: E501
        """CreateScheduledViewDefinition - a model defined in Swagger"""  # noqa: E501
        self._query = None
    ...
    @property
    def query(self):
        """Gets the query of this CreateScheduledViewDefinition.  # noqa: E501

        The query that defines the data to be included in the scheduled view.  # noqa: E501

        :return: The query of this CreateScheduledViewDefinition.  # noqa: E501
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this CreateScheduledViewDefinition.

        The query that defines the data to be included in the scheduled view.  # noqa: E501

        :param query: The query of this CreateScheduledViewDefinition.  # noqa: E501
        :type: str
        """
        if query is None:
    ...
    @property
    def index_name(self):
        """Gets the index_name of this CreateScheduledViewDefinition.  # noqa: E501

        Name of the index for the scheduled view.  # noqa: E501

        :return: The index_name of this CreateScheduledViewDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def index_name(self, index_name):
        """Sets the index_name of this CreateScheduledViewDefinition.

        Name of the index for the scheduled view.  # noqa: E501

        :param index_name: The index_name of this CreateScheduledViewDefinition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this CreateScheduledViewDefinition.  # noqa: E501

        Start timestamp in UTC in [RFC3339](https://tools.ietf.org/html/rfc3339) format.  # noqa: E501

        :return: The start_time of this CreateScheduledViewDefinition.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this CreateScheduledViewDefinition.

        Start timestamp in UTC in [RFC3339](https://tools.ietf.org/html/rfc3339) format.  # noqa: E501

        :param start_time: The start_time of this CreateScheduledViewDefinition.  # noqa: E501
        :type: datetime
        """
    ...
    def retention_period(self):
        """Gets the retention_period of this CreateScheduledViewDefinition.  # noqa: E501
        ...
        :return: The retention_period of this CreateScheduledViewDefinition.  # noqa: E501
        :rtype: int
        """
    ...
    def retention_period(self, retention_period):
        """Sets the retention_period of this CreateScheduledViewDefinition.

        The number of days to retain data in the scheduled view, or -1 to use the default value for your account.  Only relevant if your account has multi-retention. enabled.  # noqa: E501

        :param retention_period: The retention_period of this CreateScheduledViewDefinition.  # noqa: E501
        :type: int
        """
    ...
    def data_forwarding_id(self):
        """Gets the data_forwarding_id of this CreateScheduledViewDefinition.  # noqa: E501

        An optional ID of a data forwarding configuration to be used by the scheduled view.  # noqa: E501

        :return: The data_forwarding_id of this CreateScheduledViewDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def data_forwarding_id(self, data_forwarding_id):
        """Sets the data_forwarding_id of this CreateScheduledViewDefinition.

        An optional ID of a data forwarding configuration to be used by the scheduled view.  # noqa: E501

        :param data_forwarding_id: The data_forwarding_id of this CreateScheduledViewDefinition.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateScheduledViewDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateScheduledViewDefinition):
            return False
