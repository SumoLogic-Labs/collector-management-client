...
class EpochTimeRangeBoundary(TimeRangeBoundary):
    ...
    def __init__(self, epoch_millis=None, *args, **kwargs):  # noqa: E501
        """EpochTimeRangeBoundary - a model defined in Swagger"""  # noqa: E501
        self._epoch_millis = None
    ...
    def epoch_millis(self):
        """Gets the epoch_millis of this EpochTimeRangeBoundary.  # noqa: E501

        Starting point in time as a number of milliseconds since the epoch.  # noqa: E501

        :return: The epoch_millis of this EpochTimeRangeBoundary.  # noqa: E501
        :rtype: int
        """
        return self._epoch_millis

    @epoch_millis.setter
    def epoch_millis(self, epoch_millis):
        """Sets the epoch_millis of this EpochTimeRangeBoundary.

        Starting point in time as a number of milliseconds since the epoch.  # noqa: E501

        :param epoch_millis: The epoch_millis of this EpochTimeRangeBoundary.  # noqa: E501
        :type: int
        """
        if epoch_millis is None:
            raise ValueError("Invalid value for `epoch_millis`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EpochTimeRangeBoundary, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EpochTimeRangeBoundary):
            return False
