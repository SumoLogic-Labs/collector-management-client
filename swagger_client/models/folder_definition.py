...
class FolderDefinition(object):
    ...
    def __init__(self, name=None, description=None, parent_id=None):  # noqa: E501
        """FolderDefinition - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this FolderDefinition.  # noqa: E501

        The name of the folder.  # noqa: E501

        :return: The name of this FolderDefinition.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FolderDefinition.

        The name of the folder.  # noqa: E501

        :param name: The name of this FolderDefinition.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this FolderDefinition.  # noqa: E501

        The description of the folder.  # noqa: E501

        :return: The description of this FolderDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this FolderDefinition.

        The description of the folder.  # noqa: E501

        :param description: The description of this FolderDefinition.  # noqa: E501
        :type: str
        """
    ...
    @property
    def parent_id(self):
        """Gets the parent_id of this FolderDefinition.  # noqa: E501

        The identifier of the parent folder.  # noqa: E501

        :return: The parent_id of this FolderDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_id(self, parent_id):
        """Sets the parent_id of this FolderDefinition.

        The identifier of the parent folder.  # noqa: E501

        :param parent_id: The parent_id of this FolderDefinition.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FolderDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FolderDefinition):
            return False
