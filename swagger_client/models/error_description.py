...
class ErrorDescription(object):
    ...
    def __init__(self, code=None, message=None, detail=None, meta=None):  # noqa: E501
        """ErrorDescription - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._message = None
        self._detail = None
        self._meta = None
    ...
    @property
    def code(self):
        """Gets the code of this ErrorDescription.  # noqa: E501

        An error code describing the type of error.  # noqa: E501

        :return: The code of this ErrorDescription.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this ErrorDescription.

        An error code describing the type of error.  # noqa: E501

        :param code: The code of this ErrorDescription.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    @property
    def message(self):
        """Gets the message of this ErrorDescription.  # noqa: E501

        A short English-language description of the error.  # noqa: E501

        :return: The message of this ErrorDescription.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this ErrorDescription.

        A short English-language description of the error.  # noqa: E501

        :param message: The message of this ErrorDescription.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    @property
    def detail(self):
        """Gets the detail of this ErrorDescription.  # noqa: E501

        An optional fuller English-language description of the error.  # noqa: E501

        :return: The detail of this ErrorDescription.  # noqa: E501
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """Sets the detail of this ErrorDescription.

        An optional fuller English-language description of the error.  # noqa: E501

        :param detail: The detail of this ErrorDescription.  # noqa: E501
        :type: str
        """
    ...
    @property
    def meta(self):
        """Gets the meta of this ErrorDescription.  # noqa: E501

        An optional list of metadata about the error.  # noqa: E501

        :return: The meta of this ErrorDescription.  # noqa: E501
        :rtype: object
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ErrorDescription.

        An optional list of metadata about the error.  # noqa: E501

        :param meta: The meta of this ErrorDescription.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ErrorDescription, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ErrorDescription):
            return False
