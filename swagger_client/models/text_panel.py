...
class TextPanel(Panel):
    ...
    def __init__(self, text=None, *args, **kwargs):  # noqa: E501
        """TextPanel - a model defined in Swagger"""  # noqa: E501
        self._text = None
    ...
    @property
    def text(self):
        """Gets the text of this TextPanel.  # noqa: E501

        Text to be displayed in the panel.  # noqa: E501

        :return: The text of this TextPanel.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this TextPanel.

        Text to be displayed in the panel.  # noqa: E501

        :param text: The text of this TextPanel.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TextPanel):
            return False
