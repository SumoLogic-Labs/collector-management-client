...
class UpdatePartitionDefinition(object):
    ...
    def __init__(self, data_forwarding_id=None, retention_period=-1, reduce_retention_period_immediately=False):  # noqa: E501
        """UpdatePartitionDefinition - a model defined in Swagger"""  # noqa: E501
    ...
    def data_forwarding_id(self):
        """Gets the data_forwarding_id of this UpdatePartitionDefinition.  # noqa: E501

        An optional ID of a data forwarding destination to be used by the partition.  # noqa: E501

        :return: The data_forwarding_id of this UpdatePartitionDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def data_forwarding_id(self, data_forwarding_id):
        """Sets the data_forwarding_id of this UpdatePartitionDefinition.

        An optional ID of a data forwarding destination to be used by the partition.  # noqa: E501

        :param data_forwarding_id: The data_forwarding_id of this UpdatePartitionDefinition.  # noqa: E501
        :type: str
        """
    ...
    def retention_period(self):
        """Gets the retention_period of this UpdatePartitionDefinition.  # noqa: E501
        ...
        :return: The retention_period of this UpdatePartitionDefinition.  # noqa: E501
        :rtype: int
        """
    ...
    def retention_period(self, retention_period):
        """Sets the retention_period of this UpdatePartitionDefinition.

        The number of days to retain data in the partition, or -1 to use the default value for your account. Only relevant if your account has variable retention enabled.  # noqa: E501

        :param retention_period: The retention_period of this UpdatePartitionDefinition.  # noqa: E501
        :type: int
        """
    ...
    def reduce_retention_period_immediately(self):
        """Gets the reduce_retention_period_immediately of this UpdatePartitionDefinition.  # noqa: E501
        ...
        :return: The reduce_retention_period_immediately of this UpdatePartitionDefinition.  # noqa: E501
        :rtype: bool
        """
    ...
    def reduce_retention_period_immediately(self, reduce_retention_period_immediately):
        """Sets the reduce_retention_period_immediately of this UpdatePartitionDefinition.

        This is required if the newly specified `retentionPeriod` is less than the existing retention period.  In such a situation, a value of `true` says that data between the existing retention period and the new retention period should be deleted immediately; if `false`, such data will be deleted after seven days. This property is optional and ignored if the specified `retentionPeriod` is greater than or equal to the current retention period.  # noqa: E501

        :param reduce_retention_period_immediately: The reduce_retention_period_immediately of this UpdatePartitionDefinition.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdatePartitionDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePartitionDefinition):
            return False
