...
'ServiceNowDefinition': 'ServiceNowDefinition'    }

    def __init__(self, type=None, name=None, description=''):  # noqa: E501
        """ConnectionDefinition - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._name = None
    ...
    @property
    def type(self):
        """Gets the type of this ConnectionDefinition.  # noqa: E501

        Type of connection. Valid values are `WebhookDefinition`, `ServiceNowDefinition`.  # noqa: E501

        :return: The type of this ConnectionDefinition.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ConnectionDefinition.

        Type of connection. Valid values are `WebhookDefinition`, `ServiceNowDefinition`.  # noqa: E501

        :param type: The type of this ConnectionDefinition.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def name(self):
        """Gets the name of this ConnectionDefinition.  # noqa: E501

        Name of connection. Name should be a valid alphanumeric value.  # noqa: E501

        :return: The name of this ConnectionDefinition.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ConnectionDefinition.

        Name of connection. Name should be a valid alphanumeric value.  # noqa: E501

        :param name: The name of this ConnectionDefinition.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this ConnectionDefinition.  # noqa: E501

        Description of the connection.  # noqa: E501

        :return: The description of this ConnectionDefinition.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ConnectionDefinition.

        Description of the connection.  # noqa: E501

        :param description: The description of this ConnectionDefinition.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConnectionDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConnectionDefinition):
            return False
