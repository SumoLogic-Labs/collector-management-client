...
class ErrorResponse(object):
    ...
    def id(self):
        ...
        An identifier for the error; this is unique to the specific API request.  # noqa: E501
    ...
    def errors(self):
        ...
        A list of one or more causes of the error.  # noqa: E501

        :return: The errors of this ErrorResponse.  # noqa: E501
        :rtype: list[ErrorDescription]
        """
        return self._errors
