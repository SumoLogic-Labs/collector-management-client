...
class MetricsQuerySyncDefinition(object):
    ...
    def __init__(self, query=None, row_id=None):  # noqa: E501
        """MetricsQuerySyncDefinition - a model defined in Swagger"""  # noqa: E501
        self._query = None
        self._row_id = None
    ...
    @property
    def query(self):
        """Gets the query of this MetricsQuerySyncDefinition.  # noqa: E501

        The text of a metrics query.  # noqa: E501

        :return: The query of this MetricsQuerySyncDefinition.  # noqa: E501
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this MetricsQuerySyncDefinition.

        The text of a metrics query.  # noqa: E501

        :param query: The query of this MetricsQuerySyncDefinition.  # noqa: E501
        :type: str
        """
        if query is None:
    ...
    @property
    def row_id(self):
        """Gets the row_id of this MetricsQuerySyncDefinition.  # noqa: E501

        A label referring to the query; used if other metrics queries reference this one.  # noqa: E501

        :return: The row_id of this MetricsQuerySyncDefinition.  # noqa: E501
        :rtype: str
        """
        return self._row_id
    ...
    def row_id(self, row_id):
        """Sets the row_id of this MetricsQuerySyncDefinition.

        A label referring to the query; used if other metrics queries reference this one.  # noqa: E501

        :param row_id: The row_id of this MetricsQuerySyncDefinition.  # noqa: E501
        :type: str
        """
        if row_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetricsQuerySyncDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetricsQuerySyncDefinition):
            return False
