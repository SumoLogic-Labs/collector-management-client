...
class ResolvableTimeRange(object):
...
'BeginBoundedTimeRange': 'BeginBoundedTimeRange'    }
    ...
    def __init__(self, type=None):  # noqa: E501
        """ResolvableTimeRange - a model defined in Swagger"""  # noqa: E501
        self._type = None
    ...
    @property
    def type(self):
        """Gets the type of this ResolvableTimeRange.  # noqa: E501

        Type of the time range. Value must be either `CompleteLiteralTimeRange` or `BeginBoundedTimeRange`.  # noqa: E501

        :return: The type of this ResolvableTimeRange.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ResolvableTimeRange.

        Type of the time range. Value must be either `CompleteLiteralTimeRange` or `BeginBoundedTimeRange`.  # noqa: E501

        :param type: The type of this ResolvableTimeRange.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResolvableTimeRange, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResolvableTimeRange):
            return False
