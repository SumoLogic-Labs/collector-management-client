...
class ContentSyncDefinition(object):
    ...
    discriminator_value_class_map = {
          ...
          'DashboardSyncDefinition': 'DashboardSyncDefinition',
'FolderSyncDefinition': 'FolderSyncDefinition',
'MetricsSavedSearchSyncDefinition': 'MetricsSavedSearchSyncDefinition',
'SavedSearchWithScheduleSyncDefinition': 'SavedSearchWithScheduleSyncDefinition',
'LookupTableSyncDefinition': 'LookupTableSyncDefinition',
'MewboardSyncDefinition': 'MewboardSyncDefinition'    }

    def __init__(self, type=None, name=None):  # noqa: E501
        """ContentSyncDefinition - a model defined in Swagger"""  # noqa: E501
        self._type = None
        self._name = None
    ...
    @property
    def type(self):
        """Gets the type of this ContentSyncDefinition.  # noqa: E501

        The item type. Dashboard links are not supported.  # noqa: E501

        :return: The type of this ContentSyncDefinition.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ContentSyncDefinition.

        The item type. Dashboard links are not supported.  # noqa: E501

        :param type: The type of this ContentSyncDefinition.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def name(self):
        """Gets the name of this ContentSyncDefinition.  # noqa: E501

        The name of the item.  # noqa: E501

        :return: The name of this ContentSyncDefinition.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ContentSyncDefinition.

        The name of the item.  # noqa: E501

        :param name: The name of this ContentSyncDefinition.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContentSyncDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContentSyncDefinition):
            return False
