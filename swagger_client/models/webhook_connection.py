...
class WebhookConnection(Connection):
    ...
    if hasattr(Connection, "swagger_types"):
        swagger_types.update(Connection.swagger_types)
    ...
    if hasattr(Connection, "attribute_map"):
        attribute_map.update(Connection.attribute_map)

    def __init__(self, url=None, headers=None, custom_headers=None, default_payload=None, webhook_type=None, *args, **kwargs):  # noqa: E501
        """WebhookConnection - a model defined in Swagger"""  # noqa: E501
        self._url = None
        self._headers = None
    ...
    @property
    def url(self):
        """Gets the url of this WebhookConnection.  # noqa: E501

        URL for the webhook connection.  # noqa: E501

        :return: The url of this WebhookConnection.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this WebhookConnection.

        URL for the webhook connection.  # noqa: E501

        :param url: The url of this WebhookConnection.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    @property
    def headers(self):
        """Gets the headers of this WebhookConnection.  # noqa: E501

        List of access authorization headers.  # noqa: E501

        :return: The headers of this WebhookConnection.  # noqa: E501
        :rtype: list[Header]
        """
    ...
    def headers(self, headers):
        """Sets the headers of this WebhookConnection.

        List of access authorization headers.  # noqa: E501

        :param headers: The headers of this WebhookConnection.  # noqa: E501
        :type: list[Header]
        """
        if headers is None:
    ...
    def custom_headers(self):
        """Gets the custom_headers of this WebhookConnection.  # noqa: E501

        List of custom webhook headers.  # noqa: E501

        :return: The custom_headers of this WebhookConnection.  # noqa: E501
        :rtype: list[Header]
        """
    ...
    def custom_headers(self, custom_headers):
        """Sets the custom_headers of this WebhookConnection.

        List of custom webhook headers.  # noqa: E501

        :param custom_headers: The custom_headers of this WebhookConnection.  # noqa: E501
        :type: list[Header]
        """
    ...
    def default_payload(self):
        """Gets the default_payload of this WebhookConnection.  # noqa: E501

        Default payload of the webhook.  # noqa: E501

        :return: The default_payload of this WebhookConnection.  # noqa: E501
        :rtype: str
        """
    ...
    def default_payload(self, default_payload):
        """Sets the default_payload of this WebhookConnection.

        Default payload of the webhook.  # noqa: E501

        :param default_payload: The default_payload of this WebhookConnection.  # noqa: E501
        :type: str
        """
    ...
    def webhook_type(self):
        """Gets the webhook_type of this WebhookConnection.  # noqa: E501

        Type of webhook. Valid values are `AWSLambda`, `Azure`, `Datadog`, `HipChat`, `PagerDuty`, `Slack`, `Webhook`, and `NewRelic`.  # noqa: E501

        :return: The webhook_type of this WebhookConnection.  # noqa: E501
        :rtype: str
        """
    ...
    def webhook_type(self, webhook_type):
        """Sets the webhook_type of this WebhookConnection.

        Type of webhook. Valid values are `AWSLambda`, `Azure`, `Datadog`, `HipChat`, `PagerDuty`, `Slack`, `Webhook`, and `NewRelic`.  # noqa: E501

        :param webhook_type: The webhook_type of this WebhookConnection.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WebhookConnection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebhookConnection):
            return False
