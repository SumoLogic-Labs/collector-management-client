...
class ColoringThreshold(object):
    ...
    def __init__(self, color=None, min=None, max=None):  # noqa: E501
        """ColoringThreshold - a model defined in Swagger"""  # noqa: E501
        self._color = None
        self._min = None
        self._max = None
    ...
    @property
    def color(self):
        """Gets the color of this ColoringThreshold.  # noqa: E501

        Color for the threshold.  # noqa: E501

        :return: The color of this ColoringThreshold.  # noqa: E501
        :rtype: str
        """
        return self._color
    ...
    def color(self, color):
        """Sets the color of this ColoringThreshold.

        Color for the threshold.  # noqa: E501

        :param color: The color of this ColoringThreshold.  # noqa: E501
        :type: str
        """
        if color is None:
    ...
    @property
    def min(self):
        """Gets the min of this ColoringThreshold.  # noqa: E501

        Absolute inclusive threshold to color by.  # noqa: E501

        :return: The min of this ColoringThreshold.  # noqa: E501
        :rtype: float
        """
        return self._min
    ...
    @min.setter
    def min(self, min):
        """Sets the min of this ColoringThreshold.

        Absolute inclusive threshold to color by.  # noqa: E501

        :param min: The min of this ColoringThreshold.  # noqa: E501
        :type: float
        """
    ...
    @property
    def max(self):
        """Gets the max of this ColoringThreshold.  # noqa: E501

        Absolute exclusive threshold to color by.  # noqa: E501

        :return: The max of this ColoringThreshold.  # noqa: E501
        :rtype: float
        """
        return self._max
    ...
    @max.setter
    def max(self, max):
        """Sets the max of this ColoringThreshold.

        Absolute exclusive threshold to color by.  # noqa: E501

        :param max: The max of this ColoringThreshold.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ColoringThreshold, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ColoringThreshold):
            return False
