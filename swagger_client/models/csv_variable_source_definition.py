...
class CsvVariableSourceDefinition(VariableSourceDefinition):
    ...
    def __init__(self, values=None, *args, **kwargs):  # noqa: E501
        """CsvVariableSourceDefinition - a model defined in Swagger"""  # noqa: E501
        self._values = None
    ...
    @property
    def values(self):
        """Gets the values of this CsvVariableSourceDefinition.  # noqa: E501

        Comma separated values for the variable.  # noqa: E501

        :return: The values of this CsvVariableSourceDefinition.  # noqa: E501
        :rtype: str
        """
        return self._values
    ...
    def values(self, values):
        """Sets the values of this CsvVariableSourceDefinition.

        Comma separated values for the variable.  # noqa: E501

        :param values: The values of this CsvVariableSourceDefinition.  # noqa: E501
        :type: str
        """
        if values is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CsvVariableSourceDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CsvVariableSourceDefinition):
            return False
