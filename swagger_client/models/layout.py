...
import six
from swagger_client.models.layout_structure import LayoutStructure  # noqa: F401,E501
...
class Layout(object):
    ...
    swagger_types = {
        'layout_type': 'str',
        'layout_structures': 'list[LayoutStructure]'
    }

    attribute_map = {
        'layout_type': 'layoutType',
        'layout_structures': 'layoutStructures'
    }
    ...
    def __init__(self, layout_type=None, layout_structures=None):  # noqa: E501
        """Layout - a model defined in Swagger"""  # noqa: E501
        self._layout_type = None
        self._layout_structures = None
        self.discriminator = 'layoutType'
        self.layout_type = layout_type
        self.layout_structures = layout_structures

    @property
    def layout_type(self):
        """Gets the layout_type of this Layout.  # noqa: E501

        Type of layout of panels on Dashboard. Example layouts Grid, Tabs, Hierarchical etc. Currently supports `Grid` only  # noqa: E501

        :return: The layout_type of this Layout.  # noqa: E501
        :rtype: str
        """
    ...
    def layout_type(self, layout_type):
        """Sets the layout_type of this Layout.

        Type of layout of panels on Dashboard. Example layouts Grid, Tabs, Hierarchical etc. Currently supports `Grid` only  # noqa: E501

        :param layout_type: The layout_type of this Layout.  # noqa: E501
        :type: str
        """
        if layout_type is None:
            raise ValueError("Invalid value for `layout_type`, must not be `None`")  # noqa: E501

        self._layout_type = layout_type

    @property
    def layout_structures(self):
        """Gets the layout_structures of this Layout.  # noqa: E501

        Layout structures for the panel's childen.  # noqa: E501

        :return: The layout_structures of this Layout.  # noqa: E501
        :rtype: list[LayoutStructure]
        """
        return self._layout_structures

    @layout_structures.setter
    def layout_structures(self, layout_structures):
        """Sets the layout_structures of this Layout.

        Layout structures for the panel's childen.  # noqa: E501

        :param layout_structures: The layout_structures of this Layout.  # noqa: E501
        :type: list[LayoutStructure]
        """
        if layout_structures is None:
            raise ValueError("Invalid value for `layout_structures`, must not be `None`")  # noqa: E501

        self._layout_structures = layout_structures
