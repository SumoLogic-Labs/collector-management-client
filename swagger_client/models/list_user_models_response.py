...
import six
from swagger_client.models.user_model import UserModel  # noqa: F401,E501


class ListUserModelsResponse(object):
    ...
    def __init__(self, data=None, next=None):  # noqa: E501
        """ListUserModelsResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._next = None
    ...
    @property
    def data(self):
        """Gets the data of this ListUserModelsResponse.  # noqa: E501

        List of users.  # noqa: E501

        :return: The data of this ListUserModelsResponse.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ListUserModelsResponse.

        List of users.  # noqa: E501

        :param data: The data of this ListUserModelsResponse.  # noqa: E501
        :type: list[UserModel]
        """
        if data is None:
    ...
    @property
    def next(self):
        """Gets the next of this ListUserModelsResponse.  # noqa: E501

        Next continuation token.  # noqa: E501

        :return: The next of this ListUserModelsResponse.  # noqa: E501
        :rtype: str
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this ListUserModelsResponse.

        Next continuation token.  # noqa: E501

        :param next: The next of this ListUserModelsResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListUserModelsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListUserModelsResponse):
            return False
