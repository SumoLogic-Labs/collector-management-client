...
class LogQueryVariableSourceDefinition(VariableSourceDefinition):
    ...
    def __init__(self, query=None, field=None, *args, **kwargs):  # noqa: E501
        """LogQueryVariableSourceDefinition - a model defined in Swagger"""  # noqa: E501
        self._query = None
        self._field = None
    ...
    @property
    def query(self):
        """Gets the query of this LogQueryVariableSourceDefinition.  # noqa: E501

        A log query.  # noqa: E501

        :return: The query of this LogQueryVariableSourceDefinition.  # noqa: E501
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this LogQueryVariableSourceDefinition.

        A log query.  # noqa: E501

        :param query: The query of this LogQueryVariableSourceDefinition.  # noqa: E501
        :type: str
        """
        if query is None:
    ...
    @property
    def field(self):
        """Gets the field of this LogQueryVariableSourceDefinition.  # noqa: E501

        A field in log query to populate the variable values.  # noqa: E501

        :return: The field of this LogQueryVariableSourceDefinition.  # noqa: E501
        :rtype: str
        """
        return self._field
    ...
    def field(self, field):
        """Sets the field of this LogQueryVariableSourceDefinition.

        A field in log query to populate the variable values.  # noqa: E501

        :param field: The field of this LogQueryVariableSourceDefinition.  # noqa: E501
        :type: str
        """
        if field is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LogQueryVariableSourceDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LogQueryVariableSourceDefinition):
            return False
