...
class BulkErrorResponse(object):
    ...
    def __init__(self, status=None, error_response=None):  # noqa: E501
        """BulkErrorResponse - a model defined in Swagger"""  # noqa: E501
        self._status = None
    ...
    @property
    def status(self):
        """Gets the status of this BulkErrorResponse.  # noqa: E501

        HTTP status code of individual request  # noqa: E501

        :return: The status of this BulkErrorResponse.  # noqa: E501
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this BulkErrorResponse.

        HTTP status code of individual request  # noqa: E501

        :param status: The status of this BulkErrorResponse.  # noqa: E501
        :type: int
        """
        if status is None:
    ...
    def error_response(self):
        """Gets the error_response of this BulkErrorResponse.  # noqa: E501


        :return: The error_response of this BulkErrorResponse.  # noqa: E501
        :rtype: ErrorResponse
        """
    ...
    def error_response(self, error_response):
        """Sets the error_response of this BulkErrorResponse.


        :param error_response: The error_response of this BulkErrorResponse.  # noqa: E501
        :type: ErrorResponse
        """
        if error_response is None:
            raise ValueError("Invalid value for `error_response`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkErrorResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkErrorResponse):
            return False
