...
class BeginAsyncJobResponse(object):
    ...
    def __init__(self, id=None):  # noqa: E501
        """BeginAsyncJobResponse - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this BeginAsyncJobResponse.  # noqa: E501

        Identifier to get the status of an asynchronous job.  # noqa: E501

        :return: The id of this BeginAsyncJobResponse.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this BeginAsyncJobResponse.

        Identifier to get the status of an asynchronous job.  # noqa: E501

        :param id: The id of this BeginAsyncJobResponse.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BeginAsyncJobResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BeginAsyncJobResponse):
            return False
