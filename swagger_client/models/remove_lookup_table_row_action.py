...
class RemoveLookupTableRowAction(Action):
    ...
    def __init__(self, lookup_table_id=None, key_values=None, lookup_table_path=None, *args, **kwargs):  # noqa: E501
        """RemoveLookupTableRowAction - a model defined in Swagger"""  # noqa: E501
    ...
    def lookup_table_id(self):
        """Gets the lookup_table_id of this RemoveLookupTableRowAction.  # noqa: E501

        The identifier of the lookup table being updated.  # noqa: E501

        :return: The lookup_table_id of this RemoveLookupTableRowAction.  # noqa: E501
        :rtype: str
        """
    ...
    def lookup_table_id(self, lookup_table_id):
        """Sets the lookup_table_id of this RemoveLookupTableRowAction.

        The identifier of the lookup table being updated.  # noqa: E501

        :param lookup_table_id: The lookup_table_id of this RemoveLookupTableRowAction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def key_values(self):
        """Gets the key_values of this RemoveLookupTableRowAction.  # noqa: E501

        The key column values to remove from the table.  # noqa: E501

        :return: The key_values of this RemoveLookupTableRowAction.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def key_values(self, key_values):
        """Sets the key_values of this RemoveLookupTableRowAction.

        The key column values to remove from the table.  # noqa: E501

        :param key_values: The key_values of this RemoveLookupTableRowAction.  # noqa: E501
        :type: dict(str, str)
        """
        if key_values is None:
            raise ValueError("Invalid value for `key_values`, must not be `None`")  # noqa: E501

        self._key_values = key_values

    @property
    def lookup_table_path(self):
        """Gets the lookup_table_path of this RemoveLookupTableRowAction.  # noqa: E501

        The path of the lookup table being updated.  # noqa: E501

        :return: The lookup_table_path of this RemoveLookupTableRowAction.  # noqa: E501
        :rtype: str
        """
    ...
    def lookup_table_path(self, lookup_table_path):
        """Sets the lookup_table_path of this RemoveLookupTableRowAction.

        The path of the lookup table being updated.  # noqa: E501

        :param lookup_table_path: The lookup_table_path of this RemoveLookupTableRowAction.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RemoveLookupTableRowAction, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoveLookupTableRowAction):
            return False
