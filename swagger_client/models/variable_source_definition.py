...
class VariableSourceDefinition(object):
    ...
    """
    swagger_types = {
        'variable_source_type': 'str'
    }

    attribute_map = {
        'variable_source_type': 'variableSourceType'
    }

    discriminator_value_class_map = {

          'CsvVariableSourceDefinition': 'CsvVariableSourceDefinition',
'MetricsQueryVariableSourceDefinition': 'MetricsQueryVariableSourceDefinition',
'MagellanMetadataVariableSourceDefinition': 'MagellanMetadataVariableSourceDefinition',
'LogQueryVariableSourceDefinition': 'LogQueryVariableSourceDefinition'    }

    def __init__(self, variable_source_type=None):  # noqa: E501
        """VariableSourceDefinition - a model defined in Swagger"""  # noqa: E501
        self._variable_source_type = None
        self.discriminator = 'variableSourceType'
        self.variable_source_type = variable_source_type

    @property
    def variable_source_type(self):
        """Gets the variable_source_type of this VariableSourceDefinition.  # noqa: E501

        Source type of the variable values.  # noqa: E501

        :return: The variable_source_type of this VariableSourceDefinition.  # noqa: E501
        :rtype: str
        """
        return self._variable_source_type

    @variable_source_type.setter
    def variable_source_type(self, variable_source_type):
        """Sets the variable_source_type of this VariableSourceDefinition.

        Source type of the variable values.  # noqa: E501

        :param variable_source_type: The variable_source_type of this VariableSourceDefinition.  # noqa: E501
        :type: str
        """
        if variable_source_type is None:
            raise ValueError("Invalid value for `variable_source_type`, must not be `None`")  # noqa: E501

        self._variable_source_type = variable_source_type
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VariableSourceDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VariableSourceDefinition):
            return False
