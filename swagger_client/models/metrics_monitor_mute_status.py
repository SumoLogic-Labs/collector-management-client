...
class MetricsMonitorMuteStatus(object):
    ...
    def __init__(self, is_muted=None, duration=None, muted_at=None):  # noqa: E501
        """MetricsMonitorMuteStatus - a model defined in Swagger"""  # noqa: E501
        self._is_muted = None
        self._duration = None
        self._muted_at = None
        ...
        if muted_at is not None:
            self.muted_at = muted_at

    @property
    def is_muted(self):
        """Gets the is_muted of this MetricsMonitorMuteStatus.  # noqa: E501

        Is the monitor muted.  # noqa: E501

        :return: The is_muted of this MetricsMonitorMuteStatus.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_muted(self, is_muted):
        """Sets the is_muted of this MetricsMonitorMuteStatus.

        Is the monitor muted.  # noqa: E501

        :param is_muted: The is_muted of this MetricsMonitorMuteStatus.  # noqa: E501
        :type: bool
        """
        if is_muted is None:
    ...
    @property
    def duration(self):
        """Gets the duration of this MetricsMonitorMuteStatus.  # noqa: E501

        Duration to mute the monitor in milliseconds.  # noqa: E501

        :return: The duration of this MetricsMonitorMuteStatus.  # noqa: E501
        :rtype: int
        """
    ...
    def duration(self, duration):
        """Sets the duration of this MetricsMonitorMuteStatus.

        Duration to mute the monitor in milliseconds.  # noqa: E501

        :param duration: The duration of this MetricsMonitorMuteStatus.  # noqa: E501
        :type: int
        """
    ...
    @property
    def muted_at(self):
        """Gets the muted_at of this MetricsMonitorMuteStatus.  # noqa: E501

        Date and time the monitor was muted in ISO 8601 format.  # noqa: E501

        :return: The muted_at of this MetricsMonitorMuteStatus.  # noqa: E501
        :rtype: datetime
        """
        return self._muted_at

    @muted_at.setter
    def muted_at(self, muted_at):
        """Sets the muted_at of this MetricsMonitorMuteStatus.

        Date and time the monitor was muted in ISO 8601 format.  # noqa: E501

        :param muted_at: The muted_at of this MetricsMonitorMuteStatus.  # noqa: E501
        :type: datetime
        """

        self._muted_at = muted_at
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetricsMonitorMuteStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetricsMonitorMuteStatus):
            return False
