...
class MetricsSavedSearchQuerySyncDefinition(object):
    ...
    def __init__(self, row_id=None, query=None):  # noqa: E501
        """MetricsSavedSearchQuerySyncDefinition - a model defined in Swagger"""  # noqa: E501
        self._row_id = None
        self._query = None
    ...
    @property
    def row_id(self):
        """Gets the row_id of this MetricsSavedSearchQuerySyncDefinition.  # noqa: E501

        Row id. All rows ids are represented by subsequent upper case letters starting with `A`.  # noqa: E501

        :return: The row_id of this MetricsSavedSearchQuerySyncDefinition.  # noqa: E501
        :rtype: str
        """
        return self._row_id
    ...
    def row_id(self, row_id):
        """Sets the row_id of this MetricsSavedSearchQuerySyncDefinition.

        Row id. All rows ids are represented by subsequent upper case letters starting with `A`.  # noqa: E501

        :param row_id: The row_id of this MetricsSavedSearchQuerySyncDefinition.  # noqa: E501
        :type: str
        """
        if row_id is None:
    ...
    @property
    def query(self):
        """Gets the query of this MetricsSavedSearchQuerySyncDefinition.  # noqa: E501

        Metrics query.  # noqa: E501

        :return: The query of this MetricsSavedSearchQuerySyncDefinition.  # noqa: E501
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this MetricsSavedSearchQuerySyncDefinition.

        Metrics query.  # noqa: E501

        :param query: The query of this MetricsSavedSearchQuerySyncDefinition.  # noqa: E501
        :type: str
        """
        if query is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetricsSavedSearchQuerySyncDefinition, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetricsSavedSearchQuerySyncDefinition):
            return False
