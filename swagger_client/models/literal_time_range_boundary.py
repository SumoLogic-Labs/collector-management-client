...
class LiteralTimeRangeBoundary(TimeRangeBoundary):
    ...
    def __init__(self, range_name=None, *args, **kwargs):  # noqa: E501
        """LiteralTimeRangeBoundary - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def range_name(self):
        """Gets the range_name of this LiteralTimeRangeBoundary.  # noqa: E501

        Name of the time range. Possible values are:   - `now`,   - `second`,   - `minute`,   - `hour`,   - `day`,   - `today`,   - `week`,   - `month`,   - `year`  # noqa: E501

        :return: The range_name of this LiteralTimeRangeBoundary.  # noqa: E501
        :rtype: str
        """
    ...
    def range_name(self, range_name):
        """Sets the range_name of this LiteralTimeRangeBoundary.

        Name of the time range. Possible values are:   - `now`,   - `second`,   - `minute`,   - `hour`,   - `day`,   - `today`,   - `week`,   - `month`,   - `year`  # noqa: E501

        :param range_name: The range_name of this LiteralTimeRangeBoundary.  # noqa: E501
        :type: str
        """
        if range_name is None:
            raise ValueError("Invalid value for `range_name`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LiteralTimeRangeBoundary, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LiteralTimeRangeBoundary):
            return False
