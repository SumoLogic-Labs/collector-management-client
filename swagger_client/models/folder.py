...
import six
from swagger_client.models.content import Content  # noqa: F401,E501
...
class Folder(Content):
    ...
    if hasattr(Content, "swagger_types"):
        swagger_types.update(Content.swagger_types)

    attribute_map = {
        'description': 'description',
        'children': 'children'
    }
    if hasattr(Content, "attribute_map"):
        attribute_map.update(Content.attribute_map)
    ...
    def children(self):
        ...
        A list of the content items.  # noqa: E501
