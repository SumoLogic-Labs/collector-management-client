...
from swagger_client.models.rules_library_base_update import RulesLibraryBaseUpdate  # noqa: F401,E501


class RulesLibraryRuleUpdate(RulesLibraryBaseUpdate):
    ...
    if hasattr(RulesLibraryBaseUpdate, "swagger_types"):
        swagger_types.update(RulesLibraryBaseUpdate.swagger_types)
    ...
    if hasattr(RulesLibraryBaseUpdate, "attribute_map"):
        attribute_map.update(RulesLibraryBaseUpdate.attribute_map)

    def __init__(self, status=None, filters=None, join_expression=None, aggregation=None, rule_actions=None, *args, **kwargs):  # noqa: E501
        """RulesLibraryRuleUpdate - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._filters = None
        ...
        RulesLibraryBaseUpdate.__init__(self, *args, **kwargs)

    @property
    def status(self):
        """Gets the status of this RulesLibraryRuleUpdate.  # noqa: E501

        The status of the cloud SIEM rule, either active or inactive.  # noqa: E501

        :return: The status of this RulesLibraryRuleUpdate.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this RulesLibraryRuleUpdate.

        The status of the cloud SIEM rule, either active or inactive.  # noqa: E501

        :param status: The status of this RulesLibraryRuleUpdate.  # noqa: E501
        :type: str
        """
        if status is None:
    ...
    @property
    def filters(self):
        """Gets the filters of this RulesLibraryRuleUpdate.  # noqa: E501

        A list of expressions describing what the cloud SIEM rule filters.  # noqa: E501

        :return: The filters of this RulesLibraryRuleUpdate.  # noqa: E501
        :rtype: list[Filter]
        """
    ...
    def filters(self, filters):
        """Sets the filters of this RulesLibraryRuleUpdate.

        A list of expressions describing what the cloud SIEM rule filters.  # noqa: E501

        :param filters: The filters of this RulesLibraryRuleUpdate.  # noqa: E501
        :type: list[Filter]
        """
        if filters is None:
    ...
    def join_expression(self):
        """Gets the join_expression of this RulesLibraryRuleUpdate.  # noqa: E501

        An expression describing what the cloud SIEM rule joins.  # noqa: E501

        :return: The join_expression of this RulesLibraryRuleUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def join_expression(self, join_expression):
        """Sets the join_expression of this RulesLibraryRuleUpdate.

        An expression describing what the cloud SIEM rule joins.  # noqa: E501

        :param join_expression: The join_expression of this RulesLibraryRuleUpdate.  # noqa: E501
        :type: str
        """
    ...
    def aggregation(self):
        """Gets the aggregation of this RulesLibraryRuleUpdate.  # noqa: E501


        :return: The aggregation of this RulesLibraryRuleUpdate.  # noqa: E501
        :rtype: Aggregation
        """
    ...
    def aggregation(self, aggregation):
        """Sets the aggregation of this RulesLibraryRuleUpdate.


        :param aggregation: The aggregation of this RulesLibraryRuleUpdate.  # noqa: E501
        :type: Aggregation
        """
    ...
    def rule_actions(self):
        """Gets the rule_actions of this RulesLibraryRuleUpdate.  # noqa: E501


        :return: The rule_actions of this RulesLibraryRuleUpdate.  # noqa: E501
        :rtype: RuleActions
        """
    ...
    def rule_actions(self, rule_actions):
        """Sets the rule_actions of this RulesLibraryRuleUpdate.


        :param rule_actions: The rule_actions of this RulesLibraryRuleUpdate.  # noqa: E501
        :type: RuleActions
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RulesLibraryRuleUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RulesLibraryRuleUpdate):
            return False
