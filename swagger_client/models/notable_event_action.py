...
from swagger_client.models.notable_event_field import NotableEventField  # noqa: F401,E501


class NotableEventAction(Action):
    ...
    def __init__(self, name=None, description=None, severity=None, fields=None, *args, **kwargs):  # noqa: E501
        """NotableEventAction - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this NotableEventAction.  # noqa: E501

        The name of the notable event.  # noqa: E501

        :return: The name of this NotableEventAction.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NotableEventAction.

        The name of the notable event.  # noqa: E501

        :param name: The name of this NotableEventAction.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this NotableEventAction.  # noqa: E501

        The description of the notable event.  # noqa: E501

        :return: The description of this NotableEventAction.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this NotableEventAction.

        The description of the notable event.  # noqa: E501

        :param description: The description of this NotableEventAction.  # noqa: E501
        :type: str
        """
    ...
    @property
    def severity(self):
        """Gets the severity of this NotableEventAction.  # noqa: E501

        The severity of the notable event.  # noqa: E501

        :return: The severity of this NotableEventAction.  # noqa: E501
        :rtype: int
        """
    ...
    def severity(self, severity):
        """Sets the severity of this NotableEventAction.

        The severity of the notable event.  # noqa: E501

        :param severity: The severity of this NotableEventAction.  # noqa: E501
        :type: int
        """
        if severity is None:
    ...
    @property
    def fields(self):
        """Gets the fields of this NotableEventAction.  # noqa: E501

        The fields to add to the notable event.  # noqa: E501

        :return: The fields of this NotableEventAction.  # noqa: E501
        :rtype: list[NotableEventField]
        """
        return self._fields

    @fields.setter
    def fields(self, fields):
        """Sets the fields of this NotableEventAction.

        The fields to add to the notable event.  # noqa: E501

        :param fields: The fields of this NotableEventAction.  # noqa: E501
        :type: list[NotableEventField]
        """
        if fields is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NotableEventAction, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NotableEventAction):
            return False
