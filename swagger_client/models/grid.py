...
class Grid(Layout):
    ...
    if hasattr(Layout, "swagger_types"):
        swagger_types.update(Layout.swagger_types)

    attribute_map = {
    }
    if hasattr(Layout, "attribute_map"):
        attribute_map.update(Layout.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """Grid - a model defined in Swagger"""  # noqa: E501
