...
class MetricsMonitorRuleTimeThreshold(object):
    ...
    def __init__(self, duration=None, percentage=None):  # noqa: E501
        """MetricsMonitorRuleTimeThreshold - a model defined in Swagger"""  # noqa: E501
        self._duration = None
    ...
    @property
    def duration(self):
        """Gets the duration of this MetricsMonitorRuleTimeThreshold.  # noqa: E501

        Monitor timeframe in milliseconds.  # noqa: E501

        :return: The duration of this MetricsMonitorRuleTimeThreshold.  # noqa: E501
        :rtype: int
        """
    ...
    def duration(self, duration):
        """Sets the duration of this MetricsMonitorRuleTimeThreshold.

        Monitor timeframe in milliseconds.  # noqa: E501

        :param duration: The duration of this MetricsMonitorRuleTimeThreshold.  # noqa: E501
        :type: int
        """
        if duration is None:
    ...
    @property
    def percentage(self):
        """Gets the percentage of this MetricsMonitorRuleTimeThreshold.  # noqa: E501

        The minimum percentage of values that must fit in time series before an alert is triggered. If a single value is enough to trigger alert, set this field to 0.  # noqa: E501

        :return: The percentage of this MetricsMonitorRuleTimeThreshold.  # noqa: E501
        :rtype: int
        """
    ...
    def percentage(self, percentage):
        """Sets the percentage of this MetricsMonitorRuleTimeThreshold.

        The minimum percentage of values that must fit in time series before an alert is triggered. If a single value is enough to trigger alert, set this field to 0.  # noqa: E501

        :param percentage: The percentage of this MetricsMonitorRuleTimeThreshold.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetricsMonitorRuleTimeThreshold, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetricsMonitorRuleTimeThreshold):
            return False
