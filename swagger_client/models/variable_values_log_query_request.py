...
class VariableValuesLogQueryRequest(object):
    ...
    def __init__(self, query=None, field=None):  # noqa: E501
        """VariableValuesLogQueryRequest - a model defined in Swagger"""  # noqa: E501
        self._query = None
        self._field = None
    ...
    @property
    def query(self):
        """Gets the query of this VariableValuesLogQueryRequest.  # noqa: E501

        The original log query of the variable.  # noqa: E501

        :return: The query of this VariableValuesLogQueryRequest.  # noqa: E501
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this VariableValuesLogQueryRequest.

        The original log query of the variable.  # noqa: E501

        :param query: The query of this VariableValuesLogQueryRequest.  # noqa: E501
        :type: str
        """
        if query is None:
    ...
    @property
    def field(self):
        """Gets the field of this VariableValuesLogQueryRequest.  # noqa: E501

        A field in log query to populate the variable values.  # noqa: E501

        :return: The field of this VariableValuesLogQueryRequest.  # noqa: E501
        :rtype: str
        """
        return self._field
    ...
    def field(self, field):
        """Sets the field of this VariableValuesLogQueryRequest.

        A field in log query to populate the variable values.  # noqa: E501

        :param field: The field of this VariableValuesLogQueryRequest.  # noqa: E501
        :type: str
        """
        if field is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VariableValuesLogQueryRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VariableValuesLogQueryRequest):
            return False
