...
import six
from swagger_client.models.metrics_monitor_instance import MetricsMonitorInstance  # noqa: F401,E501


class MetricsMonitorsResponse(object):
    ...
    """
    swagger_types = {
        'data': 'list[MetricsMonitorInstance]',
        'next': 'str'
    }
    ...
    def __init__(self, data=None, next=None):  # noqa: E501
        """MetricsMonitorsResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._next = None
    ...
    @property
    def data(self):
        """Gets the data of this MetricsMonitorsResponse.  # noqa: E501

        List of metrics monitors.  # noqa: E501

        :return: The data of this MetricsMonitorsResponse.  # noqa: E501
        :rtype: list[MetricsMonitorInstance]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this MetricsMonitorsResponse.

        List of metrics monitors.  # noqa: E501

        :param data: The data of this MetricsMonitorsResponse.  # noqa: E501
        :type: list[MetricsMonitorInstance]
        """
        if data is None:
    ...
    @property
    def next(self):
        """Gets the next of this MetricsMonitorsResponse.  # noqa: E501

        Next continuation token.  # noqa: E501

        :return: The next of this MetricsMonitorsResponse.  # noqa: E501
        :rtype: str
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this MetricsMonitorsResponse.

        Next continuation token.  # noqa: E501

        :param next: The next of this MetricsMonitorsResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetricsMonitorsResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetricsMonitorsResponse):
            return False
