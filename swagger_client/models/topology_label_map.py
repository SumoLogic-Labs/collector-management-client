...
import six
from swagger_client.models.topology_label_values_list import TopologyLabelValuesList  # noqa: F401,E501


class TopologyLabelMap(object):
    ...
    """
    swagger_types = {
        'data': 'dict(str, TopologyLabelValuesList)'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """TopologyLabelMap - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this TopologyLabelMap.  # noqa: E501


        :return: The data of this TopologyLabelMap.  # noqa: E501
        :rtype: dict(str, TopologyLabelValuesList)
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this TopologyLabelMap.


        :param data: The data of this TopologyLabelMap.  # noqa: E501
        :type: dict(str, TopologyLabelValuesList)
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TopologyLabelMap, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TopologyLabelMap):
            return False
